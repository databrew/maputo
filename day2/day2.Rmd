...
## Categorical|Bar chart -- Counts
```{r, echo=FALSE, fig.width=9, fig.height=4.3, eval=FALSE}
# Plot the distribution of race with modified colors and labels
ggplot(marriage, aes(x = race)) +
  geom_bar(fill = "lightseagreen",
           color="black") +
...
## Bivariate graphs - categorical and categorical

## Bivariate graphs - categorical and numeric

## Bivariate graphs - numeric and numeric
